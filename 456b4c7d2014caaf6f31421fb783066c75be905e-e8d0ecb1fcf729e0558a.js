...
`;const tt=t=>{const{big:r=!1,direction:a,reverse:o=!1,...n}=t,i=(0,e.useMemo)(()=>function(t,r,a){switch(a){case"bottom-left":return r?Z:k;case"bottom-right":return r?U:V;case"down":return t?r?H:Y:r?W:S;case"left":return t?r?q:O:r?P:C;case"right":return t?r?J:z:r?G:X;case"top-left":return r?K:N;case"top-right":return r?L:I;case"up":return t?r?T:j:r?Q:M;default:return r?B:w}}(r,o,a),[r,a,o]);return c(R,{keyframes:i,...n})};m.i7`
  from {
