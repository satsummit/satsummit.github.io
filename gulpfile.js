...
gulp.task('serve', ['vendorScripts', 'javascript', 'styles', 'jekyll'], function () {
  ...
  gulp.watch([
    ...
    '!source/assets/graphics/collecticons/**/*'
  ], ['jekyll', reload]);

  gulp.watch('source/assets/graphics/collecticons/**', ['collecticons']);
...
gulp.task('javascript', function () {
  var watcher = watchify(browserify({
    entries: ['./source/assets/scripts/main.js'],
    debug: true,
    cache: {},
    packageCache: {},
    fullPaths: true
