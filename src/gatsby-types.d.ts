...
type Insights = Node & {
  ...
  readonly editions: Maybe<ReadonlyArray<InsightsEdition>>;
  readonly id: Scalars['ID'];
  readonly internal: Internal;
  readonly parent: Maybe<Node>;
  readonly published: Scalars['Boolean'];
