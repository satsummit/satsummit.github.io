...
function Prose({ children, ...props }: StackProps) {
  return (
    <Stack as='article' gap={4} alignItems='start' {...props}>
      {children}
    </Stack>
  );
}
...
const mdComponents: Readonly<MDXComponents> = {
  ...
  h4: (props) => <Heading as='h4' mt='0.5em' size={{ base: 'lg', lg: 'xl' }} {...props} />,
  h5: (props) => <Heading as='h5' mt='0.5em' size={{ base: 'md', lg: 'lg' }} {...props} />,
  h6: (props) => <Heading as='h6' mt='0.5em' size={{ base: 'sm', lg: 'md' }} {...props} />,
